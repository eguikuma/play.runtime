...
実行ファイルが起動されると、[read.user-space](https://github.com/eguikuma/read.user-space) の [02-fork-exec](https://github.com/eguikuma/read.user-space/blob/main/02-fork-exec.md) で学んだ `execve()` システムコールが呼ばれます
