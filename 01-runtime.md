...
[read.user-space](https://github.com/eguikuma/read.user-space) の [01-process](https://github.com/eguikuma/read.user-space/blob/main/01-process.md) で、「プロセスとは実行中のプログラム」であることを学びました
...
[01-process](https://github.com/eguikuma/read.user-space/blob/main/01-process.md) で学んだ「プロセス」と、ランタイムはどのような関係にあるのでしょうか？
...
これらは [read.kernel-space](https://github.com/eguikuma/read.kernel-space) で詳しく学べます
